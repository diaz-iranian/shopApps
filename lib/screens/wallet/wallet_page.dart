                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        padding: const EdgeInsets.all(16.0),
                        child: Text(
                            openOptions.value > 0 ? '' : 'Ketuk untuk membayar / meminta',
                            style: TextStyle(fontSize: 10)),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text('Permintaan Uang Cepat'),
                      ),
                      Flexible(
                        child: Center(
                            ...
                            itemBuilder: (_, index) => Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.symmetric(vertical:8.0),
                                        child: Text('Diskon 10% untuk setiap produk',style: TextStyle(
                                                color: Colors.grey,
                                                fontSize: 10.0,)),
                                      ),
                                    ],

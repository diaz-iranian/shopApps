...
//                mainAxisSize: MainAxisSize.min,
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text('Masukkan Jumlah yang Anda Ingin Minta',
                          ...
                          Text('Anda hanya bisa mengirim \$54.24',
                    ...
                    Flexible(
                      ...
                      children: <Widget>[
                        ListTile(
                          title: Text('24th juni 2020',
                              style: TextStyle(
                                  color: Colors.grey[600],
                                  fontWeight: FontWeight.bold)),
                          subtitle: Text('Diterima'),
                          trailing: Row(
                            mainAxisSize: MainAxisSize.min,
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
